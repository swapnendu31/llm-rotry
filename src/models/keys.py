...
class Keys(BaseModel):
    ...
    rpmon : Optional[RPM] = Field(description="The request limits for the key per month",default=None)
    rpm : Optional[RPM] = Field(description="The request limits for the key per minute",default=None)
    rpd : Optional[RPD] = Field(description="The request limits for the key per day",default=None)
    tpd : Optional[TPD] = Field(description="The token limits for the key per day",default=None)
    tpm : Optional[TPM] = Field(description="The token limits for the key per minute",default=None)
    tpmon : Optional[TPM] = Field(description="The token limits for the key per month",default=None)
