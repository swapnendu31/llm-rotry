...
class Keys(BaseModel):
    ...
    rpmon : Optional[int] = Field(description="The number of requests per month",default="Nil")
    rpm : Optional[int] = Field(description="The number of requests per minute",default="Nil")
    rpd : Optional[int] = Field(description="The request limits for the key per day",default="Nil")
    tpd : Optional[int] = Field(description="The token limits for the key per day",default="Nil")
    tpm : Optional[int] = Field(description="The token limits for the key per minute",default="Nil")
    tpmon : Optional[int] = Field(description="The token limits for the key per month",default="Nil")
